    ...
    return (
      <nav className={"menu" + this.state.openClass}>
        <NavLink
          to="/"
          exact
          onClick={this.menuSquareClickHandler}
        ...
        >
          <div
            className={"menu-square menu-3" + this.getSquareClass("/education")}
          >
            <FontAwesomeIcon icon="university" />
            <div className="menu-text">Education</div>
          </div>
        </NavLink>
        <NavLink
          to="/experience"
        ...
        >
          <div
            className={
              "menu-square menu-4" + this.getSquareClass("/experience")
            }
          >
            <FontAwesomeIcon icon="briefcase" />
            <div className="menu-text">Experience</div>
          </div>
        </NavLink>
      </nav>
    );
